  ...
  return (
    <Grid container columnSpacing={"80px"}>
      ...
      <Grid item mt={["32px", "32px", "0px"]} xs={12} md={5} order={[2, 2, 1]}>
        ...
        >
          {t("titleA")} <ColorText textcolor="#207754"> {t("titleColor")}</ColorText>
        </HeadingText>
        <Box mt={["8px", "8px", "32px"]}>
        ...
        <Box mt={"32px"} display={"flex"} justifyContent={"flex-start"}>
          <Box>
            <SecondaryButton1
              ...
              onClick={() => {
                navigate.push("/investment-view-input");
              }}
            >
      ...
      <Grid item xs={12} md={7} order={[1, 1, 2]}>
        <img
          style={{ width: "100%" }}
          src={getAssetUrl("/redesign/investment_box.webp")}
          alt={"header"}
        />
      </Grid>
    </Grid>
...
export default InvetmentHeader;
