...
import { InvestmentTableType } from "../../type";

type InvestmentQuickWayBreakdownDataProps = {
  investmentData: InvestmentTableType;
  invText: string;
};
const InvestmentQuickWayBreakdownData: FC<
  InvestmentQuickWayBreakdownDataProps
> = ({ investmentData, invText }) => {
  const { mobileView } = useWindowSize();
  const { t } = useTranslation("investmentview");

  return (
    <CardContainer p={["20px", "20px", "50px"]}>
...
export default InvestmentQuickWayBreakdownData;
